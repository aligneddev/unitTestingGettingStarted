...
namespace Api.Integration.Tests
{
    ...
    public class WeatherIntegrationTests : IClassFixture<UnitTestingApiWebApplicationFactory<Startup>>
    {
        private readonly HttpClient _client;
        private readonly UnitTestingApiWebApplicationFactory<Startup> _factory;

        public WeatherIntegrationTests(UnitTestingApiWebApplicationFactory<Startup> factory)
        {
        ...
        public async Task WeatherController_GetCurrentTemp_WithZipCode_ReturnsOkWithTemp()
        {
            ...
            // Arrange
            var getWeatherHttpClient = new Moq.Mock<IGetWeatherHttpClient>();
