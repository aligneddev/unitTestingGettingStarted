...
namespace Api.UnitTests.Weather
{
    ...
    public class WeatherControllerTests
    {
        ...
        {
            // Arrange
            var (weatherController, _) = Factory();

            // we won't get to the client call, so no stubs setup needed
       ...
       */
        ...
        public async Task WeatherController_CurrentTemp_ValidZipCode_CallsWithZipCode()
        {
            ...
            // setup the stub and fake the return from weather provider with MOQ
            var fakeTemp = 72.6;
